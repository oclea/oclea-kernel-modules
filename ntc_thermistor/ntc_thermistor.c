...
static const struct platform_device_id ntc_thermistor_id[] = {
	...
	{ "ecth100505103f3435f", TYPE_ECTH100505103F3435FST },
    { "sdnt1005x104f42550ftf", TYPE_SDNT1005X104F42550FTF },
	{ },
};
...
static const struct ntc_compensation ecth100505103f3435f[] = {
	{ .temp_c	= -40, .ohm	= 248277 },
	{ .temp_c	= -35, .ohm	= 182221 },
	{ .temp_c	= -30, .ohm	= 135452 },
	{ .temp_c	= -25, .ohm	= 101898 },
	{ .temp_c	= -20, .ohm	= 77523 },
	{ .temp_c	= -15, .ohm	= 59606 },
	{ .temp_c	= -10, .ohm	= 46290 },
	{ .temp_c	= -5, .ohm	= 36290 },
...
static const struct ntc_compensation sdnt1005x104f42550ftf[] = {
	{ .temp_c	= -40, .ohm	= 5319893 },
	{ .temp_c	= -35, .ohm	= 3628214 },
	{ .temp_c	= -30, .ohm	= 2513730 },
	{ .temp_c	= -25, .ohm	= 1767530 },
	{ .temp_c	= -20, .ohm	= 1260250 },
	{ .temp_c	= -15, .ohm	= 910412 },
	{ .temp_c	= -10, .ohm	= 665864 },
	{ .temp_c	= -5, .ohm	= 492719 },
	{ .temp_c	= 0, .ohm	= 368639 },
	{ .temp_c	= 5, .ohm	= 278697 },
	{ .temp_c	= 10, .ohm	= 212791 },
	{ .temp_c	= 15, .ohm	= 163999 },
	{ .temp_c	= 20, .ohm	= 127523 },
	{ .temp_c	= 25, .ohm	= 100000 },
	{ .temp_c	= 30, .ohm	= 79049 },
	{ .temp_c	= 35, .ohm	= 62965 },
	{ .temp_c	= 40, .ohm	= 50520 },
...
static const struct of_device_id ntc_match[] = {
    ...
    { .compatible = "sunlord,sdnt1005x104f42550ftf",
        .data = &ntc_thermistor_id[9] },
...
static int get_ohm_of_thermistor(struct ntc_data *data, unsigned int uv)
{
	...
	if (uv == 0) {
		pr_warn("NTC thermistor reading 0uV, ignoring\n");
		return -EAGAIN;
	}
	if (uv >= puv) {
		pr_warn("NTC thermistor reading %uuV, more than pullup %uuV\n",
			uv, puv);
...
static int ntc_thermistor_probe(struct platform_device *pdev)
{
	...
	case TYPE_NCPXXXH103:
		...
		break;
	case TYPE_ECTH100505103F3435FST:
		data->comp = ecth100505103f3435f;
		data->n_comp = ARRAY_SIZE(ecth100505103f3435f);
		break;
	case TYPE_SDNT1005X104F42550FTF:
		data->comp = sdnt1005x104f42550ftf;
		data->n_comp = ARRAY_SIZE(sdnt1005x104f42550ftf);
		break;
	default:
